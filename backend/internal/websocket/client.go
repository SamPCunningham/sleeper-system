...
type Client struct {
	...
	// The campaign this client is subscribed to
	CampaignID int
...
func NewClient(hub *Hub, conn *websocket.Conn, campaignID, userID int) *Client {
	return &Client{
		hub:        hub,
		conn:       conn,
...
func (c *Client) readPump() {
	...
	for {
		...
		// The server broadcasts events, clients just listen
	}
}
